    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
        <div class="container-fluid">
            <div class="dashboard-heading">
                ...
                <p class="dashboard-subtitle">Transaction Details</Details>
                </p>
            </div>
            <!-- Content -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <img src="{{ Storage::url($transaction->product->galleries->first()->photos ?? '../images/icons/no-pictures.png') }}" alt="picture"
                                            class="w-100 mb-3 ">
                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        ...
                                                        <div class="product-subtitle">
                                                            {{--? Memanggil province dari tabel user dengan memanggil dari tabel province --}}
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        ...
                                                        <div class="product-subtitle">
                                                            {{--? Memanggil province dari tabel user dengan memanggil dari tabel regency --}}
